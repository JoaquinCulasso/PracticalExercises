...
//            this.listarPersonas(request, response);
    ...
    private void validarUsuario(HttpServletRequest request, HttpServletResponse response)
        ...
        //Si el usuario es válido, lo redireccionamos al caso de listarUsuarios
        if (usuarioValido) {
    ...
    //Este metodo nos permite insertar o modificar una usuario
